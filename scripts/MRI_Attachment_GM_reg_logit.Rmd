...
write.csv(Total.report, here("results/regression", "GM.reg.logit.csv"), row.names = FALSE)
```

### Plot associations between MRI features and attachment behaviours

```{r, fig.fullheight=TRUE}
data <- read.csv(here("results/regression", "GM.reg.logit.csv"), header=T, dec=".",sep=",")
...
ggsave(here("results/figures", "GM.reg.logit.heatmap.pdf"), plot = g, dpi=300)
```

```{r}
markdownToHTML("MRI_Attachment_GM_reg_logit.Rmd",output ="MRI_Attachment_GM_reg_logit.html")
```
