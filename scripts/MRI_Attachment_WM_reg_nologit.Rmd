...
write.csv(Total.report, here("results/regression", "WM.reg.nologit.csv"), row.names = FALSE)
```

### Plot associations between MRI features and attachment behaviours

```{r, fig.fullheight=TRUE}
data <- read.csv(here("results/regression", "WM.reg.nologit.csv"), header=T, dec=".",sep=",")
...
ggsave(here("results/figures", "WM.reg.nologit.heatmap.pdf"), plot = g, dpi=300)
```

```{r}
markdownToHTML("MRI_Attachment_WM_reg_nologit.Rmd",output ="MRI_Attachment_WM_reg_nologit.html")
```
