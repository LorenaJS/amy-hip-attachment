---
title: "Intrarater reliability analyses"
author: "LJS"
date: "2024-03-11"
...
```{r}
Data <- read.csv(here("raw_data", "IDs_WT_intra.csv"), header=T, dec=".",sep=",")
```
...
```{r}
write.csv(results_table, here("results/reliability", "WT_intra_rel.csv"), row.names = FALSE)
```

```{r}
markdownToHTML("MRI_Attachment_intra_rel.Rmd",output ="MRI_Attachment_intra_rel.html")
```
