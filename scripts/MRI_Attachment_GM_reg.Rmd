...
write.csv(Total.report, here("results/regression", "GM.reg.csv"), row.names = FALSE)
```
...
ggsave(here("results/figures", "GM.reg.heatmap.pdf"), plot = g, dpi=300)
```


```{r}
markdownToHTML("MRI_Attachment_GM_reg.Rmd",output ="MRI_Attachment_GM_reg.html")
```
