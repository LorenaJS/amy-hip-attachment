---
title: "MRI Attachment - Regression analyses for Amy/Hip structural connectivity and attachment behaviours (untransformed behavioural data)"
author: "LJS"
date: "2023-02-28"
...
write.csv(Total.report, here("results/regression", "WM.reg.csv"), row.names = FALSE)
```
...
data$Brain <- factor(data$Brain, levels=c("FA_amy_l", "MD_amy_l", "NDI_amy_l", "ODI_amy_l",
                                  "FA_amy_r", "MD_amy_r", "NDI_amy_r", "ODI_amy_r",
                                  "FA_hip_l", "MD_hip_l", "NDI_hip_l", "ODI_hip_l",
                                  "FA_hip_r", "MD_hip_r", "NDI_hip_r", "ODI_hip_r", 
...
ggsave(here("results/figures", "WM.reg.heatmap.pdf"), plot = g, dpi=300)
```


```{r}
markdownToHTML("MRI_Attachment_WM_reg.Rmd",output ="MRI_Attachment_WM_reg.html")
```
