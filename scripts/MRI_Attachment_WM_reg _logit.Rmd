---
title: "MRI Attachment - Regression analyses for Amy/Hip structural connectivity and attachment behaviours (transformed behavioural data)"
author: "LJS"
date: "2023-02-28"
...
write.csv(Total.report, here("results/regression", "WM.reg.logit.csv"), row.names = FALSE)
```

### Plot associations between MRI features and attachment behaviours

```{r, fig.fullheight=TRUE}
data <- read.csv(here("results/regression", "WM.reg.logit.csv"), header=T, dec=".",sep=",")
...
ggsave(here("results/figures", "WM.reg.logit.heatmap.pdf"), plot = g, dpi=300)
```

```{r}
markdownToHTML("MRI_Attachment_WM_reg_logit.Rmd",output ="MRI_Attachment_WM_reg_logit.html")
```
